...
Route::resource('userproject', 'UserParProjectController');
Route::resource('userteam', 'UserParTeamController');
Route::resource('revisepassword', 'RevisePasswordController');
